...
// let multiplicateur1 = 5;
// for (let i = 0; i < 11; i+=2){
//     console.log(`${multiplicateur1} x ${i} = ${multiplicateur1*i}`)
// }
...
// let classe = ["Aleks", "Calvin", "Marcyl", "Louis", "Adil", "Kevin", "Michael"]
// let longPrenoms = []
...
//     if(sommes[i]>60){
//         bigSommes.push(sommes[i])
//         sommes.splice(i, 1)
//         i--
//     }
// }
// console.log(sommes)
// console.log(bigSommes)
...
// let classe2 = ["Aleks", "Calvin", "Marcyl", "Louis", "Adil", "Kevin", "Michael"]
...
//      // console.log(`${lepremiereprenom} a eu ${lepremierchiffre}/20 en Math` 
    ...
    let prenom = ["Aleks", "Calvin", "Marcyl", "Louis", "Adil", "Kevin", "Michael", "Nicolas", "Isma", "Batou"]
